...
//!
//! NOTE: The `reset_members*` functions are inherent extrinsics that cannot be
//! re-benchmarked via the standard dispatch path (InherentAlreadyExecuted error).
//! Their weight values are preserved from the prior benchmark run (v51.0.0,
//! STEPS: 2, REPEAT: 1) and should be considered approximate.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// NOTE: Weight values from prior benchmark (v51.0.0, STEPS: 2, REPEAT: 1) — inherent extrinsic, cannot be re-benchmarked.
	fn reset_members_only_council(a: u32, b: u32, ) -> Weight {
...
impl WeightInfo for () {
	...
	/// Storage: `FederatedAuthorityObservation::MainChainTechnicalCommitteeAddress` (r:0 w1)
	/// Proof: `FederatedAuthorityObservation::MainChainTechnicalCommitteeAddress` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn set_technical_committee_address() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
