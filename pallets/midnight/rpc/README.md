...
|------|------------|-------------|
| `Midnight` | `Midnight<C, Block>` | RPC server implementation |
| `MidnightApi` | `trait MidnightApi` | RPC trait (generated by jsonrpsee) |
| `StateRpcError` | `enum StateRpcError` | Contract/account state errors |
| `BlockRpcError` | `enum BlockRpcError` | Block query errors |
