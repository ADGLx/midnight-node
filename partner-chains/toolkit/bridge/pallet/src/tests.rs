...
fn transfers() -> BoundedVec<BridgeTransferV1<RecipientAddress>, MaxTransfersPerBlock> {
	bounded_vec![
		BridgeTransferV1 {
			amount: 100,
			recipient: TransferRecipient::Address { recipient: AccountId32::new([2; 32]) },
			mc_tx_hash: McTxHash([1; 32])
		},
		BridgeTransferV1 { amount: 200, mc_tx_hash: McTxHash([2; 32]), recipient: TransferRecipient::Reserve },
		BridgeTransferV1 { amount: 300, mc_tx_hash: McTxHash([3; 32]), recipient: TransferRecipient::Invalid }
	]
}
